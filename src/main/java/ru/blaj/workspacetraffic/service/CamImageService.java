...
public class CamImageService {
     ...
     * @param start- фильтр по дате в виде строки в формате yyyyMMddhhmmss, все записипи больше или равные этому значению,
     *             необязательынй параметр, может быть равным null
     * @param end -   фильтр по дате в виде строки в формате yyyyMMddhhmmss, все записипи меньше или равные этому значению,
     *            необязательынй параметр, может быть равным null
